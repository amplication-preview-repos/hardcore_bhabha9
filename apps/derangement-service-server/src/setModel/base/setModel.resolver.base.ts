...
import { CreateSetModelArgs } from "./CreateSetModelArgs";
import { UpdateSetModelArgs } from "./UpdateSetModelArgs";
...
export class SetModelResolverBase {
  ...
  async createSetModel(
    @graphql.Args() args: CreateSetModelArgs
  ): Promise<SetModel> {
  ...
  async updateSetModel(
    @graphql.Args() args: UpdateSetModelArgs
  ): Promise<SetModel | null> {
    try {
